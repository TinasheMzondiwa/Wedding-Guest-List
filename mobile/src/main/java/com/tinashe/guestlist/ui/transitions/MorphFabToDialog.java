...
package com.tinashe.guestlist.ui.transitions;
...
/**
 * * Taken from Plaid App by Nick Butcher
 *
...
public class MorphFabToDialog extends ChangeBounds {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        if (endValues.view instanceof ViewGroup) {
            ...
            for (int i = 0; i < vg.getChildCount(); i++) {
                ...
                v.animate()
                        ...
                        .setDuration(150)
                        .setStartDelay(150)
                        .setInterpolator(AnimUtil.getFastOutSlowInInterpolator(vg.getContext()));
                offset *= 1.8f;
            }
        }
        ...
        transition.setInterpolator(AnimUtil.getFastOutSlowInInterpolator(sceneRoot.getContext()));
        return transition;
    }
